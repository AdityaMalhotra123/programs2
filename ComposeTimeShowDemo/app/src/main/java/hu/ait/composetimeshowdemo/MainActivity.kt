...
@Composable
fun Greeting(name: String, nrTxt: Int = 5, showText: Boolean = true, modifier: Modifier = Modifier) {
    Column {
        Text(
            text = "Hello $name!",
            modifier = modifier
...
fun ShowTime() {
    ...
    Column {
        Text("Time: $current", fontSize = 30.sp)

        ClickableText(text = AnnotatedString("Click == $current"), onClick = { current = "DEMO"})
        Button(onClick = {
